...
public class TodayAdapter extends ArrayAdapter<UpdateDataset> {
	...
	public TodayAdapter(Context context, ArrayList<UpdateDataset> upcoming) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		viewHolder.date.setText(upcoming.get(position).getStart_time() + " To " + upcoming.get(position).getEnd_time());
